...
//        }        
        stage('Deploy') {
            steps {
                ...
                sh "aws cloudformation create-stack --stack-name lambdafroms3bucket --region us-east-1 --template-body file://lambda.yml --capabilities "CAPABILITY_IAM" "CAPABILITY_NAMED_IAM""
            }
        }
    }
}
